# Extension investigation summary (as of 2026-06-17)
...
reports/extensions/PILOTS.md and the pre-session PROJECT_STATUS.md.

Authoritative companions: REPLICATION_REPORT.md (reproduction), this file
(extension), .context/extension-plan-2026-06-16.md (the live plan).
