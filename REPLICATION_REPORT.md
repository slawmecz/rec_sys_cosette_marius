...
artifacts measure catalog reachability, diagnose the Sports failure as
prefix-family competition during decoding, and test several pilot interventions
under `reports/extensions/`.
...
- Current extension/state handoff: `PROJECT_STATUS.md`, `notebooks/project_story.ipynb`,
  and `reports/extensions/PILOTS.md`.
